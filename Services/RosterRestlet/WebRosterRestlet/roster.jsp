...
<html>
    <head>
        ...
        <style type="text/css">
          ...
          */
          /*
              Created on : Mar 1, 2015, 8:45:46 PM
              Author     : andrew
          */
          table {
        ...
        <script type="text/javascript">
            ...
            function searchById(){
                ...
                $.ajax({
                    url: "/RosterRestlet/search?psuid=" + id,
                    type: "GET",
                    success: function(data){
                        roster = [];
                        roster.push(JSON.parse(data));
                        createTable();
                    }
                });
            }
            ...
            function deleteStudent(){
                ...
                if(!(id == null || id == "")){
                    ...
                    $.ajax({
                        url: "/RosterRestlet/delete?psuid=" + params,
                        type: "DELETE",
                        success: function(data){
                            getAll();
                        }
                    ...
                    $.ajax({
                        url: "/RosterRestlet/delete?team=" + params,
                        type: "DELETE",
                        success: function(data){
                            getAll();
                        }
